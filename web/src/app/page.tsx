            ...
            <div className="mx-auto w-full max-w-screen-xl">
                <section className="flex flex-col items-center gap-10 text-center">
                    ...
                    <p className="max-w-2xl text-balance text-lg text-muted-foreground sm:text-lg md:text-xl">
                        Цель проекта — создание платформы, которая улучшит координацию между ФСП и
                        регионами, упростит процессы подачи и обработки заявок, а также повысит
                        качество общения и управления данными.
                    </p>
                </section>
