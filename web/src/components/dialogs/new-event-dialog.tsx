...
import { Discipline, EventLevel, Representation, User } from "@prisma/client";
...
export function NewEventDialog({ disciplines, representation }: Props) {
                        ...
                        <div className="space-y-2">
                            ...
                            >
                                ...
                                <SelectContent>
                                    ...
                                    <SelectItem value="FEDREAL_DISTRICT">
                                        Федеральный округ
                                    </SelectItem>
                            ...
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        id="adressObject"
                                        name="adressObject"
                                        value={formData.adressObject}
                                        onChange={(e) =>
                                            handleChange("adressObject", e.target.value)
                                        }
                                        required
                                        className="bg-gray-900"
                                    />
